...
namespace AnalysisOfData
{
    class Program
    {
        ...
        {
            //
            var TSourceFile = @"E:\my document\C#\Project C#\Tdata.txt";
            ...
            //
            var QVSourceFile = @"E:\my document\C#\Project C#\QVdata.txt";
            ...
            startTime = DateTime.Now;
            //
            var qvStFilename = @"E:\my document\C#\Project C#\QVPointStorage.txt";
            var tpStFilename = @"E:\my document\C#\Project C#\TemperaturePointStorage.txt";
